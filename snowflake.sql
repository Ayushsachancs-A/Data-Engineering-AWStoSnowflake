...
create or replace storage integration s3_int
  ...
  storage_provider = s3
  enabled = true
  storage_aws_role_arn = 'Your arn after creating a role on IAM'
  storage_allowed_locations = ('URL of s3 bucket from where you are retrieving data');
...
create or replace stage ext_csv_stage
  URL = 's3://de-project-datewdata/snowflake'// s3 bucket url
